...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 49FDC102631
	for <lists+linux-omap@lfdr.de>; Tue, 19 Nov 2019 15:17:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727790AbfKSORE (ORCPT <rfc822;lists+linux-omap@lfdr.de>);
        Tue, 19 Nov 2019 09:17:04 -0500
Received: from fllv0015.ext.ti.com ([198.47.19.141]:47304 "EHLO
        fllv0015.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726682AbfKSORE (ORCPT
        <rfc822;linux-omap@vger.kernel.org>); Tue, 19 Nov 2019 09:17:04 -0500
Received: from fllv0035.itg.ti.com ([10.64.41.0])
        by fllv0015.ext.ti.com (8.15.2/8.15.2) with ESMTP id xAJEH2mT128243;
        Tue, 19 Nov 2019 08:17:02 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1574173022;
        bh=cXiv664ot8Dv0PY/FWtuGYSaL4i9hYsyy5EFL5KZPBA=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=MPTnyAI6WC+ET0jRfjWiKyGyWyubhZedheEXWwxRRdDW2dB++oyvd6Dzjc6n6KBHI
         lInOaec5uA5MTdq4gN7lI/lssjA66UTn8ST2BjXuHdvPMj6c9okBhD/THOvpLI/BQE
         ZSTA9PN30nq4QXOvx9ZnIRDiV79vNH+Zp2nHJOTk=
Received: from DFLE113.ent.ti.com (dfle113.ent.ti.com [10.64.6.34])
        by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTP id xAJEH2Sd083285;
        Tue, 19 Nov 2019 08:17:02 -0600
Received: from DFLE100.ent.ti.com (10.64.6.21) by DFLE113.ent.ti.com
 (10.64.6.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3; Tue, 19
 Nov 2019 08:17:01 -0600
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE100.ent.ti.com
 (10.64.6.21) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3 via
 Frontend Transport; Tue, 19 Nov 2019 08:17:01 -0600
Received: from sokoban.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id xAJEGvYs027070;
...
Subject: [PATCHv2.5 01/15] dt-bindings: remoteproc: Add OMAP remoteproc bindings
Date:   Tue, 19 Nov 2019 16:16:31 +0200
Message-ID: <20191119141645.19777-2-t-kristo@ti.com>
...
---
v2.5:
 - added new required properties for clocks, resets, memory-region and
   firmware-name
 - added if/then/else schema logic for reg / ti,bootreg mapping
 - force usage of only listed properties for schema (additionalProps:
   false)
 - fixed examples with the schema updates
