...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6FF0A2F803F
	for <lists+linux-omap@lfdr.de>; Fri, 15 Jan 2021 17:07:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727288AbhAOQHI (ORCPT <rfc822;lists+linux-omap@lfdr.de>);
        Fri, 15 Jan 2021 11:07:08 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56988 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726801AbhAOQHI (ORCPT
        <rfc822;linux-omap@vger.kernel.org>); Fri, 15 Jan 2021 11:07:08 -0500
Received: from mail-io1-xd30.google.com (mail-io1-xd30.google.com [IPv6:2607:f8b0:4864:20::d30])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C167FC0613C1
        for <linux-omap@vger.kernel.org>; Fri, 15 Jan 2021 08:06:27 -0800 (PST)
Received: by mail-io1-xd30.google.com with SMTP id q2so17395044iow.13
        for <linux-omap@vger.kernel.org>; Fri, 15 Jan 2021 08:06:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=8j+SubTzc7aiQoPF3+oOrZYdaeRp1EZ6gqGhEwgPi2I=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8j+SubTzc7aiQoPF3+oOrZYdaeRp1EZ6gqGhEwgPi2I=;
        b=
X-Gm-Message-State: AOAM532uqYhorHXeHsKDbEPqlynSsDIicl+JB8cKZEkmZis9iCYEaiBD
        3xHi/tOmwJdC+IkbKwTxG5qnriA8WV9ALkJAkas=
X-Google-Smtp-Source: ABdhPJzx0og6PfdVnxpFQJTLpguU0d68JWvSasxiwCBGeJdcCkAMBB0dDMktgdZuAGIJafiKQd3Znp7GqCqJVn4XQCc=
X-Received: by 2002:a6b:7501:: with SMTP id l1mr9094045ioh.92.1610726786773;
 Fri, 15 Jan 2021 08:06:26 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAHCN7xKYSPzW-Qbeqzqvey+=V9KiYcsy8uxJeW=2WRXUwAq0JA@mail.gmail.com>
From:   Adam Ford <aford173@gmail.com>
Date:   Fri, 15 Jan 2021 10:06:14 -0600
Message-ID: <CAHCN7x+pHusxQj+r0SN4KPD=ZgGg5fdLHZxasu54pPf0k4dVjA@mail.gmail.com>
...
>
> On Thu, Jan 14, 2021 at 9:42 AM Miquel Raynal <miquel.raynal@bootlin.com>=
 wrote:
> >
> > Hi Adam,
> >
...
:
> > > >
> > > > On Tue, Jan 12, 2021 at 8:35 AM Miquel Raynal <miquel.raynal@bootli=
n.com> wrote:
> > > > >
> > > > > Hi Adam,
> > > > >
> > > > > Miquel Raynal <miquel.raynal@bootlin.com> wrote on Mon, 11 Jan 20=
21
> > > > > 11:20:27 +0100:
> > > > >
> > > > > > Hi Adam,
> > > > > >
> > > > > > Adam Ford <aford173@gmail.com> wrote on Sat, 9 Jan 2021 08:46:4=
4 -0600:
> > > > > >
> > > > > > > On Tue, Sep 29, 2020 at 6:09 PM Miquel Raynal <miquel.raynal@=
bootlin.com> wrote:
> > > > > > > >
> > > > > > > > The NAND BCH control structure has nothing to do outside of=
 this
> > > > > > > > driver, all users of the nand_bch_init/free() functions jus=
t save it
> > > > > > > > to chip->ecc.priv so do it in this driver directly and retu=
rn a
...
> > > > > > > > ---
> > > > > > >
> > > > > > > Starting with this commit:  3c0fe36abebe, the kernel either d=
oesn't
> > > > > > > build or returns errors on some omap2plus devices with the fo=
llowing
> > > > > > > error:
> > > > > > >
...
, so it
> > > > > > > wasn't possible for me to determine the exact commit that bro=
ke the
> > > > > > > ECC.  If the build failed, I marked it as 'bad' to git bisect=
.
> > > > > >
> > > > > > I am sorry to hear that, I regularly rebase with a make run bet=
ween each
> > > > > > pick and push my branches to a 0-day repository to have robots =
check
> > > > > > for such errors, but sometimes I fail.
> > > > > >
> > > > > > > Newer commits have remedied the build issue, but the Invalid =
ECC
> > > > > > > layout error still exists as of 5.11-RC2.
> > > > > >
> > > > > > Ok so let's focus on these.
> > > > > >
> > > > > > > Do you have any suggestions on what I can do to remedy this? =
 I am
...
> > > > > >
> > > > > > Also, can you please add a few printk's like below and give me =
the
> > > > > > output?
> > > > >
> > > > > Will you have the time to check these soon? I am ready to help an=
d
...
> > > [    2.635253] omap2-nand 30000000.nand: using device tree for GPIO l=
ookup
> > > [    2.642150] of_get_named_gpiod_flags: parsed 'rb-gpios' property o=
f node '/o)
> > > [    2.653900] gpio gpiochip6: Persistence not supported for GPIO 0
> > > [    2.660339] nand: device found, Manufacturer ID: 0x2c, Chip ID: 0x=
bc
> > > [    2.666900] nand: Micron MT29F4G16ABBDA3W
> > > [    2.670959] nand: 512 MiB, SLC, erase size: 128 KiB, page size: 20=
48, OOB si4
...
> > zero.
>
> I will do what I can, but I am out of my element with this mtd and nand s=
tuff.
>
...
>
> [    2.621978] mtdoops: mtd device (mtddev=3Dname/number) must be supplie=
d
> [    2.629699] omap2-nand 30000000.nand: GPIO lookup for consumer rb
> [    2.635864] omap2-nand 30000000.nand: using device tree for GPIO looku=
p
...
If you have a suggestion on how you want this implemented, I can push a pat=
ch.
