...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6686613DC96
	for <lists+linux-omap@lfdr.de>; Thu, 16 Jan 2020 14:56:54 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729191AbgAPNyY (ORCPT <rfc822;lists+linux-omap@lfdr.de>);
        Thu, 16 Jan 2020 08:54:24 -0500
Received: from fllv0015.ext.ti.com ([198.47.19.141]:52556 "EHLO
        fllv0015.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729137AbgAPNyX (ORCPT
        <rfc822;linux-omap@vger.kernel.org>); Thu, 16 Jan 2020 08:54:23 -0500
Received: from lelv0265.itg.ti.com ([10.180.67.224])
        by fllv0015.ext.ti.com (8.15.2/8.15.2) with ESMTP id 00GDsMMK062517;
        Thu, 16 Jan 2020 07:54:22 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1579182862;
        bh=i7uHXRUx023MlN4mvZIagFOeDMQKcaQVDDd8DSYBe5w=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=oywSIalGEJK1OjcT2PCdbVhuPUh19JOBf6u8l+vYOTnwsbVlYo+IfUMx1j2HrS52t
         d2yAtuWxCcyUaexQcJoJxqHGKKxLQNjMCpX1yGy0zKrZ85L5I8mEd49n4JNXsdsObZ
         /mV8FjzOv3AH9ri+EOILgg73A1AxZRvNHw+V9GRc=
Received: from DLEE104.ent.ti.com (dlee104.ent.ti.com [157.170.170.34])
        by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 00GDsM6l102512
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Thu, 16 Jan 2020 07:54:22 -0600
Received: from DLEE113.ent.ti.com (157.170.170.24) by DLEE104.ent.ti.com
 (157.170.170.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3; Thu, 16
 Jan 2020 07:54:21 -0600
Received: from fllv0040.itg.ti.com (10.64.41.20) by DLEE113.ent.ti.com
 (157.170.170.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3 via
 Frontend Transport; Thu, 16 Jan 2020 07:54:21 -0600
Received: from sokoban.bb.dnainternet.fi (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id 00GDrqde048732;
        Thu, 16 Jan 2020 07:54:19 -0600
...
Subject: [PATCHv5 12/14] remoteproc/omap: add support for runtime auto-suspend/resume
Date:   Thu, 16 Jan 2020 15:53:30 +0200
Message-ID: <20200116135332.7819-13-t-kristo@ti.com>
...
---
v5:
  - add new pdata status variable for reset state, this avoids
    asserting/deasserting the rproc reset twice in a row resulting in timeout

 drivers/remoteproc/omap_remoteproc.c | 189 +++++++++++++++++++++++++--
 1 file changed, 178 insertions(+), 11 deletions(-)

diff --git a/drivers/remoteproc/omap_remoteproc.c b/drivers/remoteproc/omap_remoteproc.c
index 452ef6070175..0700d2b332f7 100644
...
+	pm_runtime_enable(&pdev->dev);
 	...
 	if (IS_ERR(oproc->fck)) {
@@ -1008,12 +1172,15 @@ static int omap_rproc_remove(struct platform_device *pdev)
 	rproc_del(rproc);
 	rproc_free(rproc);
