...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5F9F22A00B3
	for <lists+linux-omap@lfdr.de>; Fri, 30 Oct 2020 10:06:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726131AbgJ3JGH (ORCPT <rfc822;lists+linux-omap@lfdr.de>);
        Fri, 30 Oct 2020 05:06:07 -0400
Received: from sender11-of-o52.zoho.eu ([31.186.226.238]:21381 "EHLO
        ...
        with ESMTP id S1726118AbgJ3JGH (ORCPT
        <rfc822;linux-omap@vger.kernel.org>); Fri, 30 Oct 2020 05:06:07 -0400
ARC-Seal: i=1; a=rsa-sha256; t=1604048755; cv=none; 
        d=zohomail.eu; s=zohoarc; 
        b=EQt61zYtVs4VtVX8KMdsCRgMJ4OF0MJk8053T7HN6qbvEOvA8i6Idz+Nbba9bSHEmTPq6auKCuCt4N+h0dzUDBkqw6IVw1Pz/6Zw1Ca+CGILcPBz9zAZsTo39Kbh54Lhb7g1mQfvgrGAtbXM5RL0xxB25waTIFnB8cIFNowfbso=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.eu; s=zohoarc; 
        t=1604048755; h=Content-Type:Content-Transfer-Encoding:Cc:Date:From:MIME-Version:Message-ID:Subject:To; 
        bh=V4HkAuwOqb1FL5xlep1wr5kEh1io903GLoFgD55Pb7k=; 
        b=TUD9YKWrDbNbF7R2yhPTToYsyhUPU1FHvf84NSZ6uyrHbz/2yzRJ74+mkvYoxMx6D1dNsfYLGooh/osFTw8V5TnYfbNJInbp++X6L8l4jYRnPcu5KFU4R6mzsgSFBBf0tsq/lLTkPyGiKf+Ty7Pz+kioKR4k1EjW6O4BmxhMTsE=
ARC-Authentication-Results: i=1; mx.zohomail.eu;
        spf=pass  smtp.mailfrom=philipp@uvos.xyz;
        dmarc=pass header.from=<philipp@uvos.xyz> header.from=<philipp@uvos.xyz>
Received: from localhost.localdomain (ip-95-222-214-217.hsi15.unitymediagroup.de [95.222.214.217]) by mx.zoho.eu
        with SMTPS id 1604048751851743.5299797094569; Fri, 30 Oct 2020 10:05:51 +0100 (CET)
Date:   Fri, 30 Oct 2020 10:05:50 +0100
...
Subject: [PATCH v3] ARM: dts: motorola-mapphone-common: Add dts
