...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 41AC3E71D6
	for <lists+linux-omap@lfdr.de>; Mon, 28 Oct 2019 13:44:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389405AbfJ1MnY (ORCPT <rfc822;lists+linux-omap@lfdr.de>);
        Mon, 28 Oct 2019 08:43:24 -0400
Received: from lelv0142.ext.ti.com ([198.47.23.249]:46292 "EHLO
        lelv0142.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389395AbfJ1MnX (ORCPT
        <rfc822;linux-omap@vger.kernel.org>); Mon, 28 Oct 2019 08:43:23 -0400
Received: from lelv0265.itg.ti.com ([10.180.67.224])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id x9SChLZ5047814;
        Mon, 28 Oct 2019 07:43:21 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1572266601;
        bh=IukYFzDkiSMrQ6S0FDCYhbnA7FNEtc4qXaqzQbxLG6A=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=oZO1sXbYKAEfnVFby252Zg2E2IPjyukV7awiApruZTX1ns+1PLuzM63XTv9yUHxne
         p+vEcbpBuP3Z2/oxkKoMudy8yZ11Q5/ZyJ8c2kwzQPMTaZJZ9HXBl8pUcvcEyw75qY
         sNPHgq2MlIipPKPN5LqQIQioUTZ/Xnd7mU76+9dw=
Received: from DFLE111.ent.ti.com (dfle111.ent.ti.com [10.64.6.32])
        by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id x9SChLDY069688
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Mon, 28 Oct 2019 07:43:21 -0500
Received: from DFLE114.ent.ti.com (10.64.6.35) by DFLE111.ent.ti.com
 (10.64.6.32) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1713.5; Mon, 28
 Oct 2019 07:43:09 -0500
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE114.ent.ti.com
 (10.64.6.35) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1713.5 via
 Frontend Transport; Mon, 28 Oct 2019 07:43:09 -0500
Received: from sokoban.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id x9SCgoh5063574;
...
Subject: [PATCH 13/17] remoteproc/omap: add support for system suspend/resume
Date:   Mon, 28 Oct 2019 14:42:34 +0200
Message-ID: <20191028124238.19224-14-t-kristo@ti.com>
...
index 8450dd79d391..410bf1b56e93 100644
...
@@ -85,6 +89,9 @@ struct omap_rproc_timer {
...
+	bool suspend_acked;
 ...
 /**
@@ -346,6 +356,11 @@ static void omap_rproc_mbox_callback(struct mbox_client *client, void *data)
...
+		break;
 	default:
 		if (msg >= RP_MBOX_READY && msg < RP_MBOX_END_MSG)
 			return;
@@ -522,6 +537,157 @@ static const struct rproc_ops omap_rproc_ops = {
...
@@ -823,6 +997,7 @@ static int omap_rproc_probe(struct platform_device *pdev)
 release_mem:
...
@@ -838,11 +1013,16 @@ static int omap_rproc_remove(struct platform_device *pdev)
 	return 0;
 }
